...
public class MockServer {
    ...
    public MockServer(BasicHttpProcessor proc,
        ...
        this .serverParams = (params != null) ? params
                : newDefaultParams();
    ...
    public void start() throws Exception {
        ...
        ServerSocket ssock;
        if (sslcontext != null) {
            SSLServerSocketFactory sf = sslcontext
        ...
        ssock.bind( new InetSocketAddress("127.0.0.1", listenPort));
    ...
    public void awaitTermination(long timeMs)
